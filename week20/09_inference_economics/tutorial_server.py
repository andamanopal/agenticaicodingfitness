...
Launch (auto-picks a free port if 8108 is taken):
    ...
    ECON_GUIDE_PORT=8108 .venv/bin/python week20/09_inference_economics/tutorial_server.py
    # → http://127.0.0.1:8108
"""
...
STEPS = [
    {"id":"intro","group":"Foundations","kind":"concept",
     ...
     "desc":"Week 20 · Tutorial 09 of 12 · Phase: Observe, measure & optimize. This is AI "
