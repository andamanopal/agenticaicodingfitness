...
Continues the smart-hotel demo from earlier weeks:
  ...
  • Week 20  nemotron tool-calling demo      → room 1203, get_room_telemetry / dispatch_work_order
"""
...
def fresh_state() -> HotelState:
    """A small, representative slice of the building (room 1203 kept from Week 20)."""
    rooms = {
...
def _room_key(room) -> str:
    """Normalize 'Room 1203' / ' 1203 ' / 'rm 1203' → '1203' (the Week 20 tool-calling fix)."""
