...
STEPS = [
    {"id":"intro","group":"Capstone","kind":"concept",
     ...
     "desc":"Week 20 · Tutorial 12 of 12 · Phase: Capstone — combine everything. AltoTech Grand "
     "Bangkok (from Weeks 11/14/15) is now run by a self-improving, sovereign agent fleet that "
     "wires the whole Week 20 stack into ONE running system on your DGX. The tools genuinely "
...
app = FastAPI(title="Sovereign Autonomous Hotel — Week 20 capstone")
...
if __name__ == "__main__":
    ...
    banner = ["", "  ▣  Sovereign Autonomous Hotel — the Week 20 capstone (AltoTech Grand Bangkok)"]
    if config.MODE == "real":
